...
/**
 * `/terms` — Terms of Service for BeyondTheLoop and the Pre-sell. A static legal
...
export const metadata: Metadata = {
  title: "Terms of Service — BeyondTheLoop",
  description:
    "The terms that govern BeyondTheLoop and the Pre-sell of the Harness Starter Kit. Lemon Squeezy is the Merchant of Record.",
};
    ...
    >
      <article className="mx-auto max-w-3xl px-6 py-20 md:py-28">
        ...
        <Text variant="lead" className="mt-6">
          These terms cover your use of BeyondTheLoop and the Pre-sell of the{" "}
        ...
        <div className="mt-12 flex flex-col gap-10">
          <section>
            ...
            <Text className="mt-3">
              BeyondTheLoop is a small, independent project that gives away an
          ...
          <section>
            ...
            <Text className="mt-3">
              ...
              Lemon Squeezy — not BeyondTheLoop — is the legal seller for your
